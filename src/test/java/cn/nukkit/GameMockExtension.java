...
//                null
//        );
//        final PlayerSessionHolder holder = new PlayerSessionHolder(serverSession, server.getSettings().networkSettings().rateLimitSettings());
//        final NetworkPacketHandler packetHandler = new NetworkPacketHandler(server, holder);
//        when(serverSession.getPacketHandler()).thenReturn(packetHandler);
...
//        player.spawned = true;
//        TestUtils.setField(Player.class, player, "info", new Player.PlayerInfo(createIdentityClaims(), mock(ClientChainData.class), mock(SerializedSkin.class)));
...
//        try {
//            final Field field =  holder.getClass().getDeclaredField("playerHandle");
//            field.setAccessible(true);
//            field.set(holder, playerHandle);
...
//    @SneakyThrows
//    @SuppressWarnings("")
//    private static ChainValidationResult.IdentityClaims createIdentityClaims() {
//        final Class<ChainValidationResult.IdentityClaims> clazz = ChainValidationResult.IdentityClaims.class;
//        final Constructor constructor = clazz.getDeclaredConstructor(ChainValidationResult.IdentityData.class, String.class);
//        constructor.setAccessible(true);
//        return (ChainValidationResult.IdentityClaims) constructor.newInstance(createIdentityData(), "publicKey");
//    }
//
//    @SneakyThrows
//    @SuppressWarnings("")
//    private static ChainValidationResult.IdentityData createIdentityData() {
//        final Class<ChainValidationResult.IdentityData> clazz = ChainValidationResult.IdentityData.class;
//        final Constructor constructor = clazz.getDeclaredConstructor(String.class, UUID.class, String.class, String.class, String.class);
//        constructor.setAccessible(true);
//        return (ChainValidationResult.IdentityData) constructor.newInstance("DisplayName", UUID.randomUUID(), "5389120531531511", "titleId", "mid");
//    }
}
